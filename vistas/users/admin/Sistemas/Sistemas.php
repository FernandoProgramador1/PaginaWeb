...
<div class="container shadow p-5 justify-content-center bg-dark-subtle mt-4">
    ...
    <a href="index.php?page=EdicionSistemas" class="btn btn-success btn-lg ms-5">
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body overflow-auto shadow">
                            <h5 class="card-title"><?php echo $rows['NombreSistema'] ?></h5>
                            <div class="d-inline-flex">
                                <a href="index.php?page=EdicionSistemas&IdSistema=<?php echo $rows['IdSistema'] ?>" class="btn btn-success btn-sm">
                                    Actualizar
                                </a>
                            </div>
                            <div class="d-inline-flex">
                                <a href="index.php?page=SistemasAdmin&IdSistema=<?php echo $rows['IdSistema'] ?>&actionsist=delete" class="btn btn-danger btn-sm">
                                    Eliminar
                                </a>
                            </div>
                        </div>
