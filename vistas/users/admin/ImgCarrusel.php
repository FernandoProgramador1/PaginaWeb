...
?>
<title>SSETCO | Agregar Imágenes De Carrusel</title>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body overflow-auto shadow">
                            <div class="d-inline-flex">
                                <a href="index.php?page=EdicionImgCarrusel&IdK=<?php echo $rows['IdCarrusel'] ?>" class="btn btn-success btn-sm">
                                    Actualizar
                                </a>
                            </div>
                            <div class="d-inline-flex">
                                <a href="index.php?page=ImgCarrusel&IdK=<?php echo $rows['IdCarrusel'] ?>&actioncar=delete" class="btn btn-danger btn-sm">
                                    Eliminar
                                </a>
                            </div>
                        </div>
