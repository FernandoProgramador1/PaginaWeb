...
<body>
    <div class="contacto-footer-container container">
        ...
        endforeach;
        ?>
        <form id="contacto-footer" method="post" action="index.php?page=InfoContacto&actioncon=contacto"
            ...
            <div class="contacto-footer-group">
                ...
                <input type="email" id="email" name="Correo" value="<?php echo $Correo ?>" class="contactoFooter-input"
                    required>
            </div>
            <div class="contacto-form-group">
                <label for="address" class="contactoFooter-label">Dirección:</label>
                <input type="text" id="address" name="Direccion" value="<?php echo $Direccion ?>"
                    class="contactoFooter-input" required>
            </div>
            <div class="contacto-form-group">
                <label for="state" class="contactoFooter-label">Estado:</label>
                <input type="text" id="state" name="Estado" value="<?php echo $Estado ?>" class="contactoFooter-input"
                    required>
            </div>
            <div class="contacto-form-group">
                <label for="city" class="contactoFooter-label">Ciudad:</label>
                <input type="text" id="city" name="Ciudad" value="<?php echo $Ciudad ?>" class="contactoFooter-input"
                    required>
            </div>
            <div class="contacto-form-group">
                <label for="zipcode" class="contactoFooter-label">Código Postal:</label>
                <input type="text" id="zipcode" name="CodigoPostal" value="<?php echo $CodigoPostal ?>"
                    class="contactoFooter-input" required>
            </div>
            <div class="contacto-form-group">
                <label for="phone" class="contactoFooter-label">Teléfono:</label>
                <input type="tel" id="phone" name="Telefono" value="<?php echo $Telefono ?>"
                    class="contactoFooter-input" required>
            </div>
