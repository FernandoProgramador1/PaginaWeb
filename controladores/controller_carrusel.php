...
class Carruseles extends Conectar {
    private $table;
    private $view;
    private $id;
    private $lastid;
    ...
    public function insertCarrusel($file,$type) {
    ...
    public function updateCarrusel($value,$file,$type)  {
        $this->id = $value;     //ATRAPA EL ID QUE SE USARA PARA IDENTIFICAR CUAL SE CAMBIARA
        // $this->col = implode(",",$this->columsn);
        $this->values[] = $this->column[0] ."='". $file ."'";
        $this->values[] = $this->column[1] ."='". $type ."'";
    ...
    public function deleteCarrusel($value)  {
        $this->id = $value;
...
class CarruselModel extends Carruseles
{
