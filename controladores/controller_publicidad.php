...
class Publicidades extends Conectar {
    private $table;
    private $view;
    private $id;
    private $lastid;
    ...
    public function insertPublicidad($file,$type) {
    ...
    public function updatePublicidad($value,$file,$type)  {
    ...
    public function deletePublicidad($value)  {
        $this->id = $value;
...
class PublicidadModel extends Publicidades
{
